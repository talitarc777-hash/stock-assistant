...
export const TERMS: Record<TermKey, TermEntry> = {
  ...
  Ticker: { en: "Ticker", zh: "股票代號" },
  "Ticker Detail": { en: "Ticker Detail", zh: "股票詳情" },
  ...
  Glossary: { en: "Glossary", zh: "詞彙表" },
  Close: { en: "Close", zh: "收市價" },
  "Benchmark Strength": { en: "Benchmark Strength", zh: "基準相對強度" },
