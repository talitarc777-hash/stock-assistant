...
from app.services.universe_service import get_us_universe
...
def universe_tickers(
    ...
    tickers = get_us_universe(limit=limit)
    return UniverseResponse(source="curated_us_universe", count=len(tickers), tickers=tickers)
